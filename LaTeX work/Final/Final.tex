...
subsequent charts are based on this idea. \newline
...
classes and clusters, it is clear that some forests perform better than others.
\newline
...
cluster was identified by the \textit{DBSCAN} algorithm. This step is important for the user to
have a second look at the clustering with this two dimensional embedding. If both algorithms align
on the clusters, chances are that the parameters were chosen correctly. The \textit{t-SNE} algorithm
is not explained in detail at this point, as this would be too much information at this point.
