...
\textit{DBSCAN} parameters \textit{'min samples'} and \textit{'eps'} can be adjusted.
...
After introducing the user to the RF with some basic information, the first graph is shown
below.
